...
protected:
    ...
    float _servo4_out_5_ =  0.0f; //for NSE
    float _servo4_out_6_ =  0.0f; //for NSE    
    ...
    AP_Float _impulse_time; // Impulse time
    AP_Float _xd_on; //magnitude of disturbance
    bool is_xdrand_calculated = false; // Declare a flag variable
