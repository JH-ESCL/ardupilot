...
const AP_Param::GroupInfo AP_MotorsHeli_Single::var_info[] = {
    ...
    AP_GROUPINFO("EXC_Tn", 28, AP_MotorsHeli_Single, _tu, 0.0125f),
...
void AP_MotorsHeli_Single::output_to_motors()
{
    ...
    if ((current_debug_time - last_debug_time) >= 1.0f) { // Check if 1 second has passed
        ...
        char buf[100];
        snprintf(buf, sizeof(buf), "Data: [%d, %.1f,%.1f,%.1f,%.1f]", 
                matrix_type, matrix_value[0], matrix_value[1], matrix_value[2], matrix_value[3]);
    ...
    switch (_spool_state) {
        ...
        case SpoolState::THROTTLE_UNLIMITED:
            ...
            if (_excitation_enabled==1)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         { //step inj
                ...
                float t = fmod(time_now, _excitation_time * 4);


                if (t > 0 && t <= _excitation_time ){
                    ...
                    /*_servo4_out_1 = _servo4_out + _excitation_amplitude * Bv[2]/Bv[1];
                    _servo4_out_2 = _servo4_out - _excitation_amplitude;
                    _servo4_out_3 = _servo4_out;
                    _servo4_out_4 = _servo4_out;*/
                    
                    _servo4_out_1 = Bv_inv[0]*_servo4_out+Bn[0][0]*_excitation_amplitude;
                    _servo4_out_2 = Bv_inv[1]*_servo4_out+Bn[1][0]*_excitation_amplitude;
                    _servo4_out_3 = Bv_inv[2]*_servo4_out+Bn[2][0]*_excitation_amplitude;
                    _servo4_out_4 = Bv_inv[3]*_servo4_out+Bn[3][0]*_excitation_amplitude;

                    _servo4_out_5 = _servo4_out;
                    _servo4_out_6 = _servo4_out;                    
                }
                else if(t > _excitation_time && t <= _excitation_time * 2){
                    // Apply excitation to the servo output
                    _servo4_out_1 = Bv_inv[0]*_servo4_out+Bn[0][1]*_excitation_amplitude;
                    _servo4_out_2 = Bv_inv[1]*_servo4_out+Bn[1][1]*_excitation_amplitude;
                    _servo4_out_3 = Bv_inv[2]*_servo4_out+Bn[2][1]*_excitation_amplitude;
                    _servo4_out_4 = Bv_inv[3]*_servo4_out+Bn[3][1]*_excitation_amplitude;

                    _servo4_out_5 = _servo4_out;
                    _servo4_out_6 = _servo4_out;                    
                }
                else if(t > _excitation_time * 2 && t <= _excitation_time * 3){
                    // Apply excitation to the servo output
                    _servo4_out_1 = Bv_inv[0]*_servo4_out+Bn[0][2]*_excitation_amplitude;
                    _servo4_out_2 = Bv_inv[1]*_servo4_out+Bn[1][2]*_excitation_amplitude;
                    _servo4_out_3 = Bv_inv[2]*_servo4_out+Bn[2][2]*_excitation_amplitude;
                    _servo4_out_4 = Bv_inv[3]*_servo4_out+Bn[3][2]*_excitation_amplitude;
                ...
                //else if(t > _excitation_time * 3 && t <= _excitation_time * 4){
                    ...
                    // Apply excitation to the servo output
                    _servo4_out_1 = Bv_inv[0]*_servo4_out;
                    _servo4_out_2 = Bv_inv[1]*_servo4_out;
                    _servo4_out_3 = Bv_inv[2]*_servo4_out;
                    _servo4_out_4 = Bv_inv[2]*_servo4_out;
                    ...
                    _servo4_out_2 = Bv_inv[1]*_servo4_out;
                    _servo4_out_3 = Bv_inv[2]*_servo4_out;
                    _servo4_out_4 = Bv_inv[3]*_servo4_out;

                    _servo4_out_5 = _servo4_out_1;
                    _servo4_out_6 = _servo4_out_2;
            ...
            // else if(_excitation_enabled == 2) {  // sinusoidal inj
            //     _servo4_out = constrain_float(_servo4_out, -0.8f, 1.0f);

            //     // Calculate excitation value based on current time and frequency
            //     float time_now = AP_HAL::millis() * 0.001f; // converting milliseconds to seconds
            //     float cycle_time = 1.0f / _excitation_time; // period of the sinusoidal wave
            //     float t = fmod(time_now, cycle_time * 4); // modulo to keep time within 4 cycles

            //     // Calculate sinusoidal excitation
            //     float omega = 2.0f * M_PI * _excitation_time; // angular frequency
            //     float excitation = _excitation_amplitude * sin(omega * t);

            //     // Apply sinusoidal excitation to the servo outputs
            //     _servo4_out_1 = _servo4_out + excitation;
            //     _servo4_out_2 = _servo4_out - excitation;
            //     _servo4_out_3 = _servo4_out + excitation;
            //     _servo4_out_4 = _servo4_out - excitation;
